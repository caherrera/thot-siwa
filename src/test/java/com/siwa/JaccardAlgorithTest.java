...
public class JaccardAlgorithTest {
    ...
    /**
     * This test ensure the Jaccard algorithmn works with normal strings
     * @throws Exception
     */
    @Test
    public void testJaccard() throws Exception {
        String seed = "TestJaccard";
        String comparator = "Test";
        /* The second parameter indicates whether redirects must be followed or not */
        GetMethod get = client.get("/api/strings/" + seed + "/operations?operation=compare&with=" + comparator + "&criteria=jaccard", false);
        ...
        response.put("criteria", "jaccard");
        response.put("similarity", algorithms.get("jaccard").calcule(seed, comparator));
        // Verify the response
    ...
    /**
     * This test ensure the Jaccard algorithmn works with alphanumeric strings
     * @throws Exception
     */
    @Test
    public void testJaccardAlphanumeric() throws Exception {
        ...
        URLEncoder.encode(comparator, "UTF-8") + "&criteria=jaccard", false);
